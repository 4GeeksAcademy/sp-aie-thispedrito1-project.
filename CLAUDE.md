...
- **Prueba real hecha el 2026-09-25** (tablas en la §9 del documento), incluidas 4 preguntas reales por `/agent/query` con `via=mcp` (antes hubo que regenerar la `LLM_API_KEY` del proxy de 4Geeks, caducada). Pedirle al agente "cierra el ticket 22" no cambia nada: solo tiene `incidents:read`. Falta MCP Playground en Codespaces.
