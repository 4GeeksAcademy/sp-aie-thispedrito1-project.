export const findClaimById = (claims, claimId) => {
    return claims.find(c => c.claimId === claimId) || null;
};
export const findClinicianById = (clinicians, clinicianId) => {
    return clinicians.find(c => c.clinicianId === clinicianId) || null;
};
export const binarySearchClaimById = (sortedClaims, targetId) => {
    let low = 0;
